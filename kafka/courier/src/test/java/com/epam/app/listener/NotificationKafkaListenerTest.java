...
@Testcontainers
@ContextConfiguration(classes = {KafkaConsumerConfig.class, PropertiesConfig.class, NotificationKafkaListener.class, NotificationKafkaListenerTest.TestConfig.class})
