...
public class KafkaProducerConfig {
    ...
    private ProducerFactory<String, OrderMessage> orderDltProducerFactory() {
        Map<String, Object> configProps = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, OrderMessage> orderDltKafkaTemplate() {
        return new KafkaTemplate<>(orderDltProducerFactory());
    }
}
